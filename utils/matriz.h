...
std::vector<std::vector<double>> pegaColuna(std::vector<std::vector<double>> matriz, int coluna)
{
    std::vector<std::vector<double>> matriz_coluna (matriz.size(), std::vector<double> (1, 0));

    for (int i = 0; i < matriz.size(); i++)
        matriz_coluna[i][0] = matriz[i][coluna];
...
std::vector<std::vector<double>> gaussJordan(std::vector<std::vector<double>> matrix) {
    int n = matrix.size();
